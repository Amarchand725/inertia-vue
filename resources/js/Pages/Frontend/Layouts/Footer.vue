        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="payment-accept">
                ...
                <img src="{{ asset('public/frontend') }}/images/payment-2.png" alt="">
                <img src="{{ asset('public/frontend') }}/images/payment-3.png" alt="">
                <img src="{{ asset('public/frontend') }}/images/payment-4.png" alt="">
            </div>
          </div>
        </div>
      </div>
